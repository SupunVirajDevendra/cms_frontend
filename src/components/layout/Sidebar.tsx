                    ...
                    <div className="flex items-center justify-between gap-3 rounded-2xl bg-white p-3 shadow-sm border border-slate-100">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-[10px] font-medium text-slate-500 mt-1">Super User</span>
                            </div>
                        </div>
                        <button className="rounded-lg p-2 text-slate-400 hover:bg-slate-50 hover:text-red-600 transition-colors">
